...
import { PendingOrdersBadge } from "@dona-lu/components/admin/pending-orders-badge";

const links = [
  { href: "/dona-lu/painel", label: "Dashboard", icon: LayoutDashboard, exact: true },
  { href: "/dona-lu/painel/categorias", label: "Categorias", icon: Tags },
  { href: "/dona-lu/painel/produtos", label: "Produtos", icon: UtensilsCrossed },
  { href: "/dona-lu/painel/banners", label: "Banners", icon: ImageIcon },
  { href: "/dona-lu/painel/cupons", label: "Cupons", icon: TicketPercent },
  { href: "/dona-lu/painel/brindes", label: "Brindes", icon: Gift },
  { href: "/dona-lu/painel/estoque", label: "Estoque", icon: Package },
  { href: "/dona-lu/painel/receitas-base", label: "Receitas base", icon: CakeSlice },
  { href: "/dona-lu/painel/ficha-tecnica", label: "Ficha Técnica", icon: Calculator },
  { href: "/dona-lu/painel/avaliacoes", label: "Avaliações", icon: Star },
  { href: "/dona-lu/painel/configuracoes", label: "Configurações", icon: Settings },
  { href: "/dona-lu/painel/pedidos/novo", label: "Novo Pedido", icon: ShoppingCart },
  {
    href: "/dona-lu/painel/pedidos",
    label: "Pedidos",
    icon: ClipboardList,
    exact: true,
    badge: true,
  },
  { href: "/dona-lu/painel/pedidos/historico", label: "Histórico", icon: History },
];
