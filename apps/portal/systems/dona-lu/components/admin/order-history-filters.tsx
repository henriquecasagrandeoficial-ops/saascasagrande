...
import { ORDER_PERIODS, type OrderPeriod } from "@dona-lu/lib/order-period";
...
export function OrderHistoryFilters({
  ...
  function goToPeriod(period: OrderPeriod) {
    router.push(`/dona-lu/painel/pedidos/historico?period=${period}`);
  }
  ...
  function goToDate(date: string) {
    ...
    router.push(`/dona-lu/painel/pedidos/historico?date=${date}`);
  }
