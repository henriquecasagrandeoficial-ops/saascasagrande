...
import { getDashboardData } from "@dona-lu/lib/dashboard-metrics";
import { formatPercent, formatPrice } from "@dona-lu/lib/format";
import {
  Card,
  CardContent,
  CardDescription,
  CardHeader,
  CardTitle,
} from "@dona-lu/components/ui/card";
import { CategorySalesList } from "@dona-lu/components/admin/category-sales-list";
import {
  PaymentMethodsChart,
  TopProductsChart,
  WeeklyEvolutionChart,
} from "@dona-lu/components/admin/dashboard-charts-lazy";
