...
import {
  ...
  completeOrder,
  reopenOrder,
} from "@/app/dona-lu/painel/pedidos/actions";
import { usePendingOrders } from "@dona-lu/hooks/use-pending-orders";
import { canPrintOnCashierPc } from "@dona-lu/lib/print";
import { toKitchenReceiptData, type KitchenReceiptData } from "@dona-lu/lib/receipt";
import { formatOrderId } from "@dona-lu/lib/order-period";
import { PICKUP_FULFILLMENT_LABEL } from "@dona-lu/lib/orders/constants";
import { formatPhone, formatPrice } from "@dona-lu/lib/format";
import { cn } from "@dona-lu/lib/utils";
import { Button } from "@dona-lu/components/ui/button";
import { KitchenReceipt } from "@dona-lu/components/admin/kitchen-receipt";
...
export function PedidosBoard() {
  ...
  useEffect(() => {
    ...
    //   chrome.exe --kiosk-printing "https://seu-dominio/painel/pedidos"
  ...
  function handleReopen(orderId: string) {
    ...
    startTransition(async () => {
      ...
      router.push(`/dona-lu/painel/pedidos/novo?orderId=${orderId}`);
    });
  }
