...
import {
  ...
  buildSimulation,
  type PricingResult,
} from "@dona-lu/lib/pricing";
import type { SheetPricingResult } from "@dona-lu/lib/ficha-tecnica/engine";
import { cn } from "@dona-lu/lib/utils";
import { Card, CardContent, CardHeader, CardTitle } from "@dona-lu/components/ui/card";
import {
  Table,
  TableBody,
  TableCell,
