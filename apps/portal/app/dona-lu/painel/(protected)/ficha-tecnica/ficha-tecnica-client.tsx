...
import { saveFichaTecnica } from "@/app/dona-lu/painel/ficha-tecnica/actions";
import {
...
import { UNITS, type PricingMode, type Unit } from "@dona-lu/lib/pricing";
          ...
          <CardContent className="space-y-4">
            {baseRecipes.length === 0 && (
              <p className="text-xs text-stone-500">
                Sem receitas base.{" "}
                <Link
                  href="/dona-lu/painel/receitas-base"
