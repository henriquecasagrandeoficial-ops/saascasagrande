...
import { completeOrder } from "@/app/allativa/painel/pedidos/actions";
import {
  fetchWorkOrderData,
  usePendingOrders,
} from "@allativa/hooks/use-pending-orders";
import { canPrintOnCashierPc } from "@allativa/lib/print";
import type { WorkOrderData } from "@allativa/lib/receipt";
import { formatOrderId } from "@allativa/lib/order-period";
import { formatPhone, formatPrice } from "@allativa/lib/format";
import { cn } from "@allativa/lib/utils";
import { Button } from "@allativa/components/ui/button";
import { OrderAndRequisitionReceipt } from "@allativa/components/admin/order-requisition-receipt";
